            ...
            Printing.layoutPdf(onLayout: (PdfPageFormat format) async {
              ...
              pdf.addPage(
                pw.MultiPage(
                  ...
                  // The build function now returns a LIST of widgets
                  build: (pw.Context context) => <pw.Widget>[
                    ...
                    // allowing it to flow seamlessly.
                    buildSecondPage(),
                  ],
                ),
              );
        ...
        children: [
          ...
          pw.Row(
              children: [
                ...
                pw.Expanded(child: labeledCheckbox('D-Proof of possession of AADHAAR', checked: true)),
              ]
          ),
          pw.SizedBox(height: 2),
          pw.Row(
              children: [
                ...
                pw.Expanded(flex: 3, child: labeledCheckbox('F-LETTER ISSUED BY NATIONAL POPULATION REGISTER CONTAINING DETAILS OF NAME & ADDRESS')),
              ]
          ),
  ...
  pw.Widget _buildFamilyAndDependantInfo() {
    return pw.Column(
        ...
        children: [
          ...
          pw.SizedBox(height: 1),
          _formField('Name of Spouse*', charBoxes('KRITHIKA', 30), subLabel: pw.Text('(Father\'s name is mandatory if PAN is not provided)', style: const pw.TextStyle(fontSize: 6))),
          pw.SizedBox(height: 1),
          ...
          pw.SizedBox(height: 1),
          _formField('Name of Guardian', charBoxes('', 30), subLabel: pw.Text('(In Case of Minor*)', style: const pw.TextStyle(fontSize: 6.5))),
          pw.SizedBox(height: 1),
    ...
    return pw.Column(
      ...
      children: [
        ...
        _formField('Educational Qualification:', pw.Row(children: [
          labeledCheckbox('Below SSC'), pw.SizedBox(width:4),
          labeledCheckbox('SSC'), pw.SizedBox(width:4),
          labeledCheckbox('HSC'), pw.SizedBox(width:4),
          labeledCheckbox('Graduate'), pw.SizedBox(width:4),
          labeledCheckbox('Post Graduate'), pw.SizedBox(width:4),
          labeledCheckbox('Professional'), pw.SizedBox(width:4),
          labeledCheckbox('Others'),
        ])),
        pw.SizedBox(height: 2),
        ...
        _formField('Country of Tax Residence in India only and not in any other country or territory outside India*',
            ...
            width: 200),
        pw.SizedBox(height: 2),
        _formField('PAN*/Tax Identification Number or equivalent (If issued by jurisdiction)', charBoxes('', 10),
